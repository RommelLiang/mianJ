(function() {
	...
	mt = {},
	c = {
		id: "25e3b17ddf2b132427768bfebf751a76",
		dm: ["shixiann.com"],
	...
	mt.r.Sa = function(a, b) {
		...
		document.addEventListener ? e = function() {
			...
			if (!f) if (f = s, "complete" === document.readyState) a.B = s;
			else if (document.addEventListener) document.addEventListener("DOMContentLoaded", e, w),
	...
	h.w = {
		...
		function a(a, d) {
			...
			b.d(d, "Function") && (e.readyState ? e.onreadystatechange = function() {
				if ("loaded" === e.readyState || "complete" === e.readyState) e.onreadystatechange = t,
				d()
			}: e.onload = function() {
				d()
			});
		...
		function f(a) {
			...
			k = "";
			if (a in p) k = a;
			else for (var b = ["webkit", "ms", "moz", "o"], q = 0; q < b.length; q++) {
		...
		function d(a) {
			if (! ("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window)) l = "focus" == a.type || "focusin" == a.type ? s: w,
			b()
		}
		var e = mt.event,
		m = h.G,
		...
		b(); (function() {
			...
			"object" == typeof document.onfocusin ? (e.c(document, "focusin", d), e.c(document, "focusout", d)) : (e.c(window, "focus", d), e.c(window, "blur", d))
		})();
		h.F = {
			pa: function() {
				return + new Date - v
		...
		g = {
			...
			_setAutoPageview: function(a) {
				if (1 < a.length && (a = a[1], w === a || s === a)) g.e |= 2,
				h.b.S = a
			},
			_trackPageview: function(a) {
				if (1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
					...
					h.b.a.et = 0;
					h.b.a.ep = "";
					h.b.J ? (h.b.a.nv = 0, h.b.a.st = 4) : h.b.J = s;
					var b = h.b.a.u,
					d = h.b.a.su;
			...
			_trackRTEvent: function(b) {
				...
				if (f.d(b, "Object")) {
					...
					else for (var m = Math.ceil(m / 900), p = "block|" + Math.round(Math.random() * e.L).toString(16) + "|" + m + "|", q = [], u = 0; u < m; u++) q.push(u),
					q.push(b.substring(900 * u, 900 * u + 900)),
					l.call(this, p + q.join("|")),
					q = []
				}
			},
		...
		a.prototype = {
			...
			Ia: function() {
				...
				if (0 === c.nv && this.A(document.location.href) && ("" === document.referrer || this.A(document.referrer))) a = 0,
				b = 4;
				this.a.nv = a;
				this.a.st = b;
				this.a.cc = d;
			...
			da: function() {
				...
				a && (d.test(a) && e && g) && (this.a.rnd = Math.round(Math.random() * l.L), a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", l.protocol + "//" + c.js + f + ".js?" + this.a.rnd), f = document.getElementsByTagName("script")[0], f.parentNode.insertBefore(a, f))
			},
			aa: function(a) {
		...
		if ("undefined" !== typeof h.b && (c.med || (!a.T || 7 < a.ya) && c.cvcc)) {
			...
			v = function(a, f) {
				...
				if (f) {
					...
					l = f.getAttribute("id") || "";
					n.test(m) ? (g.sn = "mediate", g.snv = m) : b.d(k, "String") && n.test(k) && (g.sn = "wrap", g.snv = k);
					g.id = l
				}
				h.b.a.et = 86;
				h.b.a.ep = d.stringify(g);
			...
			g = {
				click: function() {
					for (var a = [], b = k(document.getElementsByTagName("a")), b = [].concat.apply(b, k(document.getElementsByTagName("area"))), b = [].concat.apply(b, k(document.getElementsByTagName("img"))), d, e, f = 0, g = b.length; f < g; f++) d = b[f],
				...
				g = {
					click: function() {
						for (var a = [], b = k(document.getElementsByTagName("a")), b = [].concat.apply(b, k(document.getElementsByTagName("area"))), b = [].concat.apply(b, k(document.getElementsByTagName("img"))), d, e, f, g = 0, m = b.length; g < m; g++) d = b[g],
			...
			if ("undefined" !== typeof g && "undefined" !== typeof n) {
				...
				m += /\/$/.test(m) ? "": "/";
				var u = function(a, d) {
					if (q === d) return v(m + a, d),
					w;
					if (b.d(d, "Array") || b.d(d, "NodeList")) for (var e = 0,
					f = d.length; e < f; e++) if (q === d[e]) return v(m + a + "/" + (e + 1), d[e]),
					w
				};
				f.c(document, "mousedown",
				function(a) {
					a = a || window.event;
		...
		if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
			var e = {
				$: function() {
					...
					d, g = 0; g < b; g++)(d = a.ka(decodeURIComponent(c.cvcf[g]))) && f.c(d, "click", e.ga())
				},
				ga: function() {
					return function() {
						h.b.a.et = 86;
		...
		a.prototype = {
			...
			Ba: function() {
				var a = this;
				this.la(function(d) {
					d !== r && "" !== d && (b.log("//datax.baidu.com/x.gif?dm=" + encodeURIComponent("datax.baidu.com/webadapter/guid") + "&ac=" + encodeURIComponent(d) + "&v=hm-webadapter-0.0.1&rnd=" + Math.round(2147483647 * Math.random())), a.Ha("hmKey", +new Date,
					function() {
						a.La()
					}))
				})
		...
		if (f.T && /^http(s)?:$/.test(document.location.protocol)) {
			...
			d.Aa(function(a) {
				0 === a && d.oa("hmKey",
				function(a) {
					a = +a; (isNaN(a) || 6048E5 < +new Date - a) && d.Ba()
				})
			})
		}
	})();
